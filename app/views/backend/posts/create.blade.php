...
{{-- Page title --}}
@section('title')
{{Lang::get('backend/posts/actions.create.title')}} ::
@parent
@stop
...
<div class="page-header">
	<h3>
		{{Lang::get('backend/posts/actions.create.description')}}
...
<form class="form-horizontal" method="post" action="" autocomplete="off" accept-charset="UTF-8" enctype="multipart/form-data">
	...
	<div class="tab-content">
		...
		<div class="tab-pane active" id="tab-general">
			...
			<div class="control-group {{ $errors->has('content') ? 'error' : '' }}">
				...
				<div class="controls">
					<input class="form-control" type="text" name="content" id="content" value="{{ Input::old('content') }}" />
			...
			<div class="control-group {{ $errors->has('meta_title') ? 'error' : '' }}">
				...
				<div class="controls">
					<textarea type="text" name="meta_title" id="meta_title" value="{{ Input::old('meta_title') }}"> </textarea>
			...
			<div class="control-group {{ $errors->has('meta_description') ? 'error' : '' }}">
				...
				<div class="controls">
					<textarea type="text" name="meta_description" id="meta_description" value="{{ Input::old('meta_description') }}"> </textarea>
			...
			<div class="control-group {{ $errors->has('meta_keywords') ? 'error' : '' }}">
				...
				<div class="controls">
					<textarea type="text" name="meta_keywords" id="meta_keywords" value="{{ Input::old('meta_keywords') }}"> </textarea>
	...
	<div class="control-group">
		<div class="controls">
			...
			<button type="submit" class="btn btn-success">{{Lang::get('backend/posts/actions.buttons.create')}}</button>
		</div>
	</div>
</form>
@stop
